...
public class TipsLang {
    ...
    public static void init(@NotNull UnifiedLanguageProvider provider) {
        ...
        provider.add("gtms.tooltip.wand.combo", "Active Combination: %s", "已激活组合");
        provider.add("gtms.tooltip.wand.no_modules", "No modules installed", "未安装模块");
        provider.add("gtms.tooltip.wand.installed", "Installed:", "已安装:");
        provider.add("gtms.tooltip.wand.max_slots", "Max %d modules", "最多 %d 个模块");
        provider.add("gtms.tooltip.wand.controls", "Shift+Right-click to remove, offhand to install", "潜行+右键拆卸，副手物品安装");
        ...
        provider.add("gtms.tooltip.earth_module.0",
        ...
        provider.add("gtms.tooltip.winter_module.0",
        ...
        provider.add("gtms.tooltip.wind_module.0",
        ...
        provider.add("gtms.tooltip.fire_module.0",
        ...
        provider.add("gtms.tooltip.mana_module.0",
        ...
        provider.add("gtms.tooltip.autumn_module.0",
        ...
        provider.add("gtms.tooltip.water_module.0",
        ...
        provider.add("gtms.tooltip.summer_module.0",
        ...
        provider.add("gtms.tooltip.wand.combo.tooltip", "Combo skill:", "组合技能:");
    }
}
