...
public class GTMSAddonFinder {

    private static final Logger LOGGER = LogManager.getLogger();
    protected static List<IGTMSAddon> cache = null;
    protected static Map<String, IGTMSAddon> modIdMap = new HashMap<>();

    public static List<IGTMSAddon> getAddons() {
        if (cache == null) {
            cache = getInstances(GTMSAddon.class, IGTMSAddon.class);
            for (IGTMSAddon addon : cache) {
    ...
    @Nullable
    public static IGTMSAddon getAddon(String modId) {
