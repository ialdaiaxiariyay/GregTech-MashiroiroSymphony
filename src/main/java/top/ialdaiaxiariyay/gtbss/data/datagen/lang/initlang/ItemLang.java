...
public class ItemLang {
    ...
    public static void init(UnifiedLanguageProvider provider) {
        ...
        provider.add("item.gtbss.winter_module", "Module of Winter", "冬之模块");
        provider.add("item.gtbss.wind_module", "Module of Wind", "风之模块");
        provider.add("item.gtbss.fire_module", "Module of Fire", "火之模块");
        provider.add("item.gtbss.mana_module", "Module of Mana", "魔力模块");
