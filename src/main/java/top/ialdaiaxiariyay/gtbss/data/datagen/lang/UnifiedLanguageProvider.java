package top.ialdaiaxiariyay.gtbss.data.datagen.lang;
...
public class UnifiedLanguageProvider extends LanguageProvider {
    ...
    public UnifiedLanguageProvider(@NotNull DataGenerator gen, String locale) {
        super(gen.getPackOutput(), GTBSS.MOD_ID, locale);
        this.locale = locale;
