package top.ialdaiaxiariyay.gtbss.common.machine.multiblock.part.mana;
...
import top.ialdaiaxiariyay.gtbss.api.machine.trait.NotifiableManaContainer;
import top.ialdaiaxiariyay.gtbss.api.misc.ManaContainerList;
import top.ialdaiaxiariyay.gtbss.api.misc.ManaInfoProviderList;
...
public class ManaHatchPartMachine extends TieredIOPartMachine implements ManaReceiver {
    ...
    public <T> @NotNull LazyOptional<T> getCapability(@NotNull Capability<T> cap, @Nullable Direction side) {
        if (cap == GTBSSCapability.CAPABILITY_MANA_CONTAINER) {
            if (this.manaContainer != null) {
                return GTBSSCapability.CAPABILITY_MANA_CONTAINER.orEmpty(cap,
        ...
        if (cap == GTBSSCapability.CAPABILITY_MANA_INFO_PROVIDER) {
            if (this.manaContainer != null) {
                return GTBSSCapability.CAPABILITY_MANA_INFO_PROVIDER.orEmpty(cap,
                        LazyOptional.of(() -> this.manaContainer));
            }
