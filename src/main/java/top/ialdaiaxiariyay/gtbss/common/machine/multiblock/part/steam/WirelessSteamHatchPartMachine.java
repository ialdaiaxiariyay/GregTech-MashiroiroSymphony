package top.ialdaiaxiariyay.gtbss.common.machine.multiblock.part.steam;
...
import top.ialdaiaxiariyay.gtbss.api.wireless.IWirelessContainerHolder;
import top.ialdaiaxiariyay.gtbss.api.wireless.WirelessContainer;
import top.ialdaiaxiariyay.gtbss.api.wireless.WirelessType;
...
import static top.ialdaiaxiariyay.gtbss.api.wireless.WirelessType.STEAM;
...
public class WirelessSteamHatchPartMachine extends FluidHatchPartMachine
    ...
    private Component getTeamSteamDisplay() {
        ...
        return container == null ? Component.literal("0") : Component.translatable("gtbss.gui.wireless_steam",
