...
public class MultipleRecipeWorkableManaMultiblockMachine extends WorkableManaMultiblockMachine {
    ...
    public MultipleRecipeWorkableManaMultiblockMachine(BlockEntityCreationInfo info) {
