...
public class MultipleRecipeCoilWorkableElectricMultiblockMachine extends
                                                                 MultipleRecipeWorkableElectricMultiblockMachine {
    ...
    public MultipleRecipeCoilWorkableElectricMultiblockMachine(BlockEntityCreationInfo info) {
        super(info);
    }
