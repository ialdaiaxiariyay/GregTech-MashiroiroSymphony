...
public class GTBSSCapabilityHelper {

    @Nullable
    public static IManaContainer getManaContainer(Level level, BlockPos pos, @Nullable Direction side) {
        return getBlockEntityCapability(GTBSSCapability.CAPABILITY_MANA_CONTAINER, level, pos, side);
    }

    @Nullable
    public static IManaInfoProvider getManaInfoProvider(Level level, BlockPos pos, @Nullable Direction side) {
        return getBlockEntityCapability(GTBSSCapability.CAPABILITY_MANA_INFO_PROVIDER, level, pos, side);
    }
