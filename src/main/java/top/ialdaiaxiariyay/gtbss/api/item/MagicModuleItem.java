...
public abstract class MagicModuleItem extends Item implements IMagicModule {
    ...
    public void appendHoverText(@NotNull ItemStack stack, @Nullable Level level,
        ...
        tooltipComponents
                .add(Component.translatable("gtbss.tooltip.magic_module.charge_time_modifier",
                        getChargeTimeModifier()));
        tooltipComponents.add(Component.translatable("gtbss.tooltip.magic_module.manacost", getManaCost()));
        tooltipComponents
                .add(Component.translatable("gtbss.tooltip.magic_module.skill").withStyle(ChatFormatting.AQUA));
